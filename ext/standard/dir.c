...
#ifdef GLOB_PERIOD
	REGISTER_LONG_CONSTANT("GLOB_PERIOD", GLOB_PERIOD, CONST_CS | CONST_PERSISTENT);
#else 
...
#define GLOB_AVAILABLE_FLAGS (0 | GLOB_BRACE | GLOB_MARK | GLOB_NOSORT | GLOB_NOCHECK | GLOB_NOESCAPE | GLOB_ERR | GLOB_PERIOD | GLOB_ONLYDIR)
